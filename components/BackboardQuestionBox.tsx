    ...
    <div className="fixed bottom-4 left-1/2 z-50 w-[min(95vw,760px)] -translate-x-1/2">
      <div className="flex items-center justify-center gap-2">
        ...
        <button
          ...
          className="rounded-xl border border-white/20 bg-black/55 px-3 py-5 text-[11px] font-medium uppercase tracking-[0.14em] text-zinc-100 shadow-xl shadow-black/45 backdrop-blur-xl transition hover:bg-black/75"
          aria-expanded={open}
